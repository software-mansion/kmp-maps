...
internal data class MapOptions(
    ...
    val cameraPosition: CameraPosition =
        CameraPosition(
            coordinates = Coordinates(latitude=50.04936291649514, longitude=19.96675718575716),
            zoom = 17f,
        ),
...
//        circles = if (options.showAllComponents) getExampleCircles() else emptyList(),
        ...
        onGeoJsonAreaClick = { geoJson -> println("GeoJsonArea clicked: $geoJson") },
        onGeoJsonLineClick = { geoJson -> println("GeoJsonLine clicked: $geoJson") },
        geoJsonLayers = listOf(
//            GeoJsonLayer(geoJson = EXAMPLE_POLYGON_GEO_JSON, isClickable = true),
            GeoJsonLayer(geoJson = EXAMPLE_LINE_GEO_JSON, isClickable = true),
            ),
...
private fun Map(
    ...
    onGeoJsonAreaClick: ((GeoJsonFeatureClicked) -> Unit)? = null,
    onGeoJsonLineClick: ((GeoJsonFeatureClicked) -> Unit)? = null,
